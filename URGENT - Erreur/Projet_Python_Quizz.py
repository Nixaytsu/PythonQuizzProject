...
def identification_menu():
    ...
    if choix == "1":
        joueur = identification()  # On récupère l'identifiant de l'utilisateur
        return joueur
    elif choix == "2":
        creation()
    elif choix == "3":
...
def menu_selection_de_jeu():
    ...
    if choix=="1":
        ...
        affichage_des_scores(joueur)
    elif choix =="3":
        menu()



#Fonction themes : Liste de tous les thèmes mis à disposition du joueur.
...
def enregistrement_score(joueur):
    with open('scores.txt', 'a') as fichier:
        fichier.write(f"{joueur};{scores['Histoire et Géographie']};{scores['Sciences Générales']};"
...
def affichage_des_scores(joueur):
    print("==============================================================")
    print(f"[{joueur} :                                                 ]")
