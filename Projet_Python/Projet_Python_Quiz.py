...
def themes():
    ...
    if selection == "1":
        ...
        ("Vous avez choisi le Quiz sur Les siences générale")
        quiz_science_generale()
    elif selection =="3":
...
def affichage_des_scores(written_id):
    ...
    print(f"[Score du Quiz science générales: {score_science_generales} ]")
